...
Pronto: MVP (cadastro, catálogo, prática com cronômetro, resultado com recorde e ponto fraco, progresso por tópico, planos), modo de teste, Fase 2 (streak, XP, conquistas), lições em etapas, conteúdo revisado pelo Guia Editorial (Matemática, Português) e a matéria **Sistemas Operacionais** com 20 lições (o que é um SO; componentes e funções; terminal na prática; chamadas de sistema em 2 lições; estrutura de um SO; processos; estados e transições; escalonamento; threads em 2 lições; comunicação entre processos em 5 lições; memória em 4 lições).
...
Próximas, nesta ordem: **Gerenciamento de Arquivos** (24/11 e 01/12, ~3 lições) · Gerenciamento de Dispositivos, inclui disco (08/12 e 22/12, ~3 lições) · Virtualização (02/02/27) · Estudos de Caso (os trabalhos 01 e 02).

**Com memória pronta, o conteúdo da prova de 15/12 está quase todo escrito.** Falta só Arquivos e Dispositivos Parte 1.
