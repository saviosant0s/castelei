...
Próximas, nesta ordem: Gerenciamento de Dispositivos, inclui disco (08/12 e 22/12, ~3 lições) · Virtualização (02/02/27) · Estudos de Caso (os trabalhos 01 e 02).

**Para a prova de 15/12 falta só Dispositivos Parte 1.** Todo o resto que cai nela já está escrito.
