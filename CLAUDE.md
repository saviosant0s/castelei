...
- **O editor de etapas do painel é um campo de JSON cru.** É a causa de curso sair só com texto corrido: para pôr uma figura ou uma tabela é preciso escrever JSON à mão, então quem escreve pelo painel escreve parágrafo. O aviso do validador avisa; não resolve. Um editor de blocos de verdade é a correção que falta.
